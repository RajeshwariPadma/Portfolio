    ...
    return (
        ...
        <Box >
            ...
            <Box
                sx={(theme) => ({
                    [theme.breakpoints.up("md")]: {
                        color: "white", display: "flex", flexDirection: "row", pl: 20,
                    },
                    [theme.breakpoints.down("sm")]: {
                        color: "white", display: "flex", flexDirection: "column", pl: 8,
                    }
                })}>
                <Box >
                    ...
                    <Typography
                        ...
                        }}><EmailIcon sx={{ color: " rgba(236, 243, 247, 0.93)" }} /> Email:<Typography
                            
                            sx={{ fontSize: 20, color: " rgba(241, 222, 203, 0.93)" }}>yourmail@gmail.com</Typography></Typography>
                    <Typography sx={{
                        fontWeight: "bold",
                        fontSize: 20,
                        display: "flex",
                        ...
                        gap: 1,
                        color: " rgba(115, 211, 246, 0.93)"
                    }}><LocalPhoneIcon sx={{ color: " rgba(236, 243, 247, 0.93)" }} /> Phone:<Typography
                       
                        sx={{ fontSize: 20, color: " rgba(241, 222, 203, 0.93)" }}>+91-123456987</Typography></Typography>
